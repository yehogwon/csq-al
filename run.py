if __name__ == '__main__':
    ...
    ### Dataset
    parser.add_argument('--dataset', type=str.upper, required=True, choices=['MNIST', 'FASHIONMNIST', 'SVHN', 'CIFAR10', 'CIFAR100', 'IMAGENET32', 'IMAGENET64', 'CIFAR100N', 'CIFAR100LT', 'R52'], help='dataset name')
